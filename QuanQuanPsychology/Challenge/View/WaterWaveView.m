...
- (void)initData
{
    ...
    _realWaveColor = [UIColor colorwithHexString:@"#ffc678"];
    _realWaveColor = [_realWaveColor colorWithAlphaComponent:0.8];
    _maskWaveColor = [_realWaveColor colorWithAlphaComponent:0.4];
}
