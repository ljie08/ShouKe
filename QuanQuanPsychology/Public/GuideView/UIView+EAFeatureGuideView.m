...
//            [button setBackgroundImage:[[UIImage imageNamed:featureItem.buttonBackgroundImageName ?:  @"icon_ea_background"] resizableImageWithCapInsets:UIEdgeInsetsMake(4, 4, 4, 4)] forState:UIControlStateNormal];
            [button setImage:[UIImage imageNamed:featureItem.buttonBackgroundImageName ?:  @"icon_ea_background"] forState:UIControlStateNormal];
...
- (void)buttonAction:(UIButton *) sender
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ShowNextGuide" object:[NSString stringWithFormat:@"%ld",self.tag]];
}
